...
figure;
hold on;
plot(lvr1_transfer_characteristics.Var1, lvr1_transfer_characteristics.Var2, '-o', 'LineWidth', 2);
plot(lvr2_transfer_characteristics.Var1, lvr2_transfer_characteristics.Var2, '-o', 'LineWidth', 2);
plot(lvr5_transfer_characteristics.Var1, lvr5_transfer_characteristics.Var2, '-o', 'LineWidth', 2);
hold off;

grid on;
title('Transfer Characteristics for LVR1, LVR2, and LVR5');
xlabel('U_{in} (V)');
ylabel('U_{out} (V)');
legend show;

saveas(gcf, "figures/transfer.png");
...
figure;
hold on;
plot(lvr1_load_characteristics.Var2, lvr1_load_characteristics.Var1, '-o', 'LineWidth', 2);
plot(lvr2_load_characteristics.Var2, lvr2_load_characteristics.Var1, '-o', 'LineWidth', 2);
plot(lvr5_load_characteristics.Var2, lvr5_load_characteristics.Var1, '-o', 'LineWidth', 2);
hold off;

grid on;
title('Output Characteristics for LVR1, LVR2, and LVR5');
xlabel('U_{in} (V)');
ylabel('U_{out} (V)');
legend show;

saveas(gcf, "figures/output.png");
